    ...
    <div>
      ...
      <Container className="mt-8">
        <div className="prose max-w-4xl mx-auto">
            ...
            <p className="mb-6">
                In 2021 we sought out letters from DTR students and alums, asking them to share what they got from their DTR experience. We received about 30 letters, and the students’ words provide a much better picture of DTR than our website did. We share some excerpts from these letters below.
            </p>
            ...
            <div className="mt-6 mb-6">
                In these ways, DTR provides a spectacular learning space for students. We will work hard to keep it that way. As long as DTR continues to do right by students, we will do just fine.
            </div>
        </div>
      </Container>
    </div>
...
const quoteChunks: QuoteTheme[] = [
    {
        descriptor: "Students shared that DTR helped them learn to approach and solve problems:",
        quotes: [
            {
    ...
    {
        descriptor: "Students emphasized that the learning did not stop at picking up problem solving skills, but in their orientation towards learning:",
        quotes: [
            {
    ...
    {
        descriptor: "And with support and rigor, students are able to do truly independent research, where they learn to drive the research:",
        quotes: [
            {
    ...
    {
        descriptor: "Students learn how to self-direct complex work, which in turn gives them the confidence to do so:",
        quotes: [
            {
